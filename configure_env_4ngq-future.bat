...
@set INCLUDE=%INCLUDE%;E:\builds\env\gdal-ags\include
@set LIB=%LIB%;E:\builds\env\gdal-ags\lib
path %PATH%;E:\builds\env\gdal-ags\bin;E:\builds\env\libiconv-1.14\bin;E:\builds\env\osgeo4w-iconv-1.9-dll\bin;E:\builds\nextgisqgis-compulink\bin; 
